...
import styles from "../../History/style.module.scss";
                        ...
                        listData && listData.map((item: any, index: number) => {
                            return <li key={index}>
                                ...
                                <i>
                                    ...
                                    <b onClick={() => props.navigateTo("/reportFor24", { state: item })}>查看结果</b>
                                </i>
                            </li>
                        })
                    }
